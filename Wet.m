function Wu2000_Fig5_Fig4_RMS_noColorbar_Wet()
...
Delta_wet = 0.054239 + 1j*0.051025;   
...
setup_ax(axA, cm_re, clim_re, zlim_fix, camAz, camEl, planeScale*R_island);
title(axA,'(a)  Exact:  Re(\Delta) (wet)','FontWeight','bold');
...
setup_ax(axB, cm_im, clim_im, zlim_fix, camAz, camEl, planeScale*R_island);
title(axB,'(b)  Exact:  Im(\Delta) (wet)','FontWeight','bold');
...
setup_ax(axC, cm_re, clim_re, zlim_fix, camAz, camEl, planeScale*R_island);
title(axC,'(c)  Reconstructed:  Re(\Delta) (wet)','FontWeight','bold');
...
setup_ax(axD, cm_im, clim_im, zlim_fix, camAz, camEl, planeScale*R_island);
title(axD,'(d)  Reconstructed:  Im(\Delta) (wet)','FontWeight','bold');
draw_sea_plane(axD, planeScale*R_island, z0_im);
% height = Reconstructed, color = Exact (Im)
...
title('RMS Error Curve (wet ground)');
